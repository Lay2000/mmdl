...
class StackedLinearClsHeadWithPred(ClsHead):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(StackedLinearClsHeadWithPred, self).__init__(**kwargs)
        assert num_classes > 0, \
            f'`num_classes` of StackedLinearClsHeadWithPred must be a positive ' \
        ...
        assert isinstance(mid_channels, Sequence), \
            f'`mid_channels` of StackedLinearClsHeadWithPred should be a sequence, ' \
    ...
    def get_pred_count(self):
        ...
        return self.pred_correct, self.pred_total
