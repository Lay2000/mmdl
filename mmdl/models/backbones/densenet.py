...
class DenseTransition(nn.Sequential):
    """DenseNetBase Transition Layers."""
...
class DenseNetBase(BaseBackbone):
    """DenseNetBase.
    ...
    <https://github.com/liuzhuang13/DenseNetBase>`_
    and `pytorch
    <https://github.com/pytorch/vision/blob/main/torchvision/models/densenetBase.py>`_.

    Args:
        arch (str | dict): The model's architecture. If string, it should be
            one of architecture in ``DenseNetBase.arch_settings``. And if dict, it
    ...
    def __init__(self,
        ...
        # Repetitions of DenseNetBase Blocks
    ...
    def train(self, mode=True):
        super(DenseNetBase, self).train(mode)
        self._freeze_stages()
