...
class DenseTransition(nn.Sequential):
    """DenseNetCifar Transition Layers."""
...
class DenseNetCifar(BaseBackbone):
    """DenseNetCifar.
    ...
    <https://github.com/liuzhuang13/DenseNetCifar>`_
    and `pytorch
    <https://github.com/pytorch/vision/blob/main/torchvision/models/densenetCifar.py>`_.

    Args:
        arch (str | dict): The model's architecture. If string, it should be
            one of architecture in ``DenseNetCifar.arch_settings``. And if dict, it
    ...
    def __init__(self,
        ...
        # Repetitions of DenseNetCifar Blocks
    ...
    def train(self, mode=True):
        super(DenseNetCifar, self).train(mode)
        self._freeze_stages()
